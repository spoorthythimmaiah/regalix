		...
		image: function()
		{
			return {
				...
				update: function()
				{
					...
					var imagewidth = $('#redactor-image-width').val();
					if (imagewidth > 100 && imagewidth != '') {
						$('.redactor-error-message').show();
						return;
					} else {
						$image.css({
							'width': imagewidth+'%'
					...
					this.opts.modal = {
						...
						+ '<div class="redactor-modal-tab redactor-group" data-title="General">'
							...
							+ '<div class="redactor-modal-tab-area">'
								...
								+ '<section>'
									+ '<label>Width</label>'
									+ '<input type="text" id="redactor-image-width" aria-label="" />'
									+ '<div class="redactor-error-message">Invalid value</div>'
								+ '</section>'
								+ '<section>'
