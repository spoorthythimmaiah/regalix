...
/***/ "./sharedemos/static/js/launchpad/views/launchpad.js":
/*!***********************************************************!*\
  !*** ./sharedemos/static/js/launchpad/views/launchpad.js ***!
  \***********************************************************/
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! underscore */ "./node_modules/underscore/underscore.js"), __webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! backbone */ "./node_modules/backbone/backbone.js"), __webpack_require__(/*! ../../tenant/common */ "./sharedemos/static/js/tenant/common.js"), __webpack_require__(/*! ../../tenant/models/activity */ "./sharedemos/static/js/tenant/models/activity.js"), __webpack_require__(/*! ../../pdf_viewer/views/pdf_viewer */ "./sharedemos/static/js/pdf_viewer/views/pdf_viewer.js"), __webpack_require__(/*! ../../helpers/sync */ "./sharedemos/static/js/helpers/sync.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_, $, Backbone, Common, WalkthroughActivity, PdfView) {
  'use strict';
  ...
  var LaunchpadView = Backbone.View.extend({
    ...
    events: {
      ...
      'click .content-slide-wrap img': function (event) {
    ...
    enhanceEmbedIframeSrc: function () {
      $('iframe').each(function () {
        if ($(this).attr('src')) {
          ...
          let videoData = Common.enhanceVideoURL(vidSrc); // Update iframe data only if it videoData has embedType property
...
//# sourceMappingURL=31.c7fac4.js.map