...
/***/ "./sharedemos/static/js/reports/models/reports.js":
/*!********************************************************!*\
  !*** ./sharedemos/static/js/reports/models/reports.js ***!
  \********************************************************/
...
/***/ "./sharedemos/static/js/reports/views/new_reports.js":
/*!***********************************************************!*\
  !*** ./sharedemos/static/js/reports/views/new_reports.js ***!
  \***********************************************************/
/*! no static exports found */
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! underscore */ "./node_modules/underscore/underscore.js"), __webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! backbone */ "./node_modules/backbone/backbone.js"), __webpack_require__(/*! ../models/reports */ "./sharedemos/static/js/reports/models/reports.js"), __webpack_require__(/*! ../templates/site_traffic.handlebars */ "./sharedemos/static/js/reports/templates/site_traffic.handlebars"), __webpack_require__(/*! ../templates/trending_chapters.handlebars */ "./sharedemos/static/js/reports/templates/trending_chapters.handlebars"), __webpack_require__(/*! ../templates/referrals.handlebars */ "./sharedemos/static/js/reports/templates/referrals.handlebars"), __webpack_require__(/*! ../templates/geography.handlebars */ "./sharedemos/static/js/reports/templates/geography.handlebars")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_, $, Backbone, ReportsApi, SiteTrafficTemplate, TrendingChaptersTemplate, ReferralsTemplate, GeographyTemplate) {
  ...
  var ReportsView = Backbone.View.extend({
    ...
    loadReferrals: function (referrals) {
      this.$('.referral_chart_block').html(ReferralsTemplate({
        'referrals': referrals
      }));
      ...
      if (referrals.length > 0) {
        ...
        var col1 = "#0a316b",
            ...
            col8 = "#cfddf7",
            col9 = "#ebf1fc",
            col10 = "#e9e9e9"; // Instantiate Pie Chart
    ...
    loadTrendingCategories: function (categories) {
      if (categories.length > 0) {
        ...
        $.each(categories, function (index, val) {
          ...
          trending_categories.push([index, val.views, val.name + ' : ' + val.views + word]);
        ...
        this.$('#top_trending_cat_chart').html(TrendingChaptersTemplate({
          'trending_chapters': []
        }));
      }
    },
...
//# sourceMappingURL=32.5fb929.js.map