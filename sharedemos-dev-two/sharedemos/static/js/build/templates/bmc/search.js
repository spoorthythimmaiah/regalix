...
/******/ 	return __webpack_require__(__webpack_require__.s = "./sharedemos/static/js/seo/bmc/search.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./sharedemos/static/js/seo/bmc/search.js":
/*!************************************************!*\
  !*** ./sharedemos/static/js/seo/bmc/search.js ***!
  \************************************************/
/*! no exports provided */
...
/* harmony import */ var _views_search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./views/search */ "./sharedemos/static/js/seo/bmc/views/search.js");
...
/***/ "./sharedemos/static/js/seo/bmc/templates/search.handlebars":
/*!******************************************************************!*\
  !*** ./sharedemos/static/js/seo/bmc/templates/search.handlebars ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "					<div class=\"col-xs-12 col-sm-6 col-md-4 col-lg-4 demo\">\n						<div class=\"bmc-thumbnail-cover\">\n							<a href=\""
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"link") : depth0), depth0))
    + "\" target= \"_blank\">\n								<img class=\"bmc-thumbnail\" src=\""
    + alias2(alias1((depth0 != null ? lookupProperty(depth0,"imageUrl") : depth0), depth0))
    + "\"/>\n								<div class=\"bmc-thumbnail-footer\">\n									<h4>"
  ...
  return "<div class=\"search-result-wrapper\">\n	<div class=\"container\">\n		<div class=\"search-content-list row\">\n"
    + ((stack1 = __default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/compare.js */ "./sharedemos/static/js/helpers/handlebars/compare.js")).call(alias1,((stack1 = (depth0 != null ? lookupProperty(depth0,"query") : depth0)) != null ? lookupProperty(stack1,"length") : stack1),">",1,{"name":"compare","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":4,"column":3},"end":{"line":8,"column":15}}})) != null ? stack1 : "")
    + "			<div class=\"row searched-demos\">\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"results") : depth0),{"name":"each","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":10,"column":4},"end":{"line":21,"column":13}}})) != null ? stack1 : "")
    + "			</div>\n		</div>\n		<div class=\"scroll-to-top\"></div>\n	</div>\n</div>";
},"useData":true});

/***/ }),

/***/ "./sharedemos/static/js/seo/bmc/views/search.js":
/*!******************************************************!*\
  !*** ./sharedemos/static/js/seo/bmc/views/search.js ***!
  \******************************************************/
...
/* harmony import */ var _tenant_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../tenant/common */ "./sharedemos/static/js/tenant/common.js");
/* harmony import */ var _tenant_common__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_tenant_common__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _templates_search_handlebars__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../templates/search.handlebars */ "./sharedemos/static/js/seo/bmc/templates/search.handlebars");
...
/* harmony import */ var _common_views_search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../common/views/search */ "./sharedemos/static/js/seo/common/views/search.js");
...
const searchView = backbone__WEBPACK_IMPORTED_MODULE_1___default.a.View.extend({
  el: 'body',
  template: _templates_search_handlebars__WEBPACK_IMPORTED_MODULE_3___default.a,
  ASSET_ICON: "/static/images/bmc/default_bmc.jpg",
  JOURNEY_ICON: "/static/images/journey-thumb-icon.png",
  LIBRARY_ICON: "/static/images/bmc/default_bmc.jpg",
  events: {
    'click .bmc-search-icon, .category-tags li, .playlist-tags li': 'activateSearch',
  ...
  searchSite(event) {
    ...
    if (!event.isTrigger && !_tenant_common__WEBPACK_IMPORTED_MODULE_2___default.a.isValidCharacter(event)) return;
  ...
  searchContent(event) {
    if (event.currentTarget.value.length >= 2) {
      ...
      Object(_common_views_search__WEBPACK_IMPORTED_MODULE_4__["default"])(this);
    } else {
      this.renderSearchResults();
    }
  },
  ...
  renderSearchResults(searchResults = {}) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.each(searchResultsList, function (count, searchResult) {
      ...
      if (localeId && title) {
        ...
        if (!imageUrl) {
          imageUrl = `${document.cdn_url}${category === 'journeys' ? root.JOURNEY_ICON : is_asset ? root.ASSET_ICON : root.LIBRARY_ICON}`;
        }
