...
/******/ 	return __webpack_require__(__webpack_require__.s = "./sharedemos/static/js/seo/regalix/search.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./sharedemos/static/js/seo/regalix/search.js":
/*!****************************************************!*\
  !*** ./sharedemos/static/js/seo/regalix/search.js ***!
  \****************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _views_search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./views/search */ "./sharedemos/static/js/seo/regalix/views/search.js");
...
/***/ "./sharedemos/static/js/seo/regalix/templates/search.handlebars":
/*!**********************************************************************!*\
  !*** ./sharedemos/static/js/seo/regalix/templates/search.handlebars ***!
  \**********************************************************************/
/*! no static exports found */
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"search-result-wrapper\">\n	<div class=\"container\">\n		<div class=\"search-content-list row\">\n"
    ...
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"results") : depth0),{"name":"each","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":10,"column":3},"end":{"line":21,"column":12}}})) != null ? stack1 : "")
    + "			</div>\n		</div>\n		<div class=\"scroll-to-top\"></div>\n	</div>\n</div>";
},"useData":true});

/***/ }),

/***/ "./sharedemos/static/js/seo/regalix/views/search.js":
/*!**********************************************************!*\
  !*** ./sharedemos/static/js/seo/regalix/views/search.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _templates_search_handlebars__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../templates/search.handlebars */ "./sharedemos/static/js/seo/regalix/templates/search.handlebars");
...
const searchView = backbone__WEBPACK_IMPORTED_MODULE_1___default.a.View.extend({
  ...
  renderSearchResults(searchResults = {}) {
    ...
    underscore__WEBPACK_IMPORTED_MODULE_0___default.a.each(searchResultsList, searchResult => {
      let title = searchResult[`title_${localeId}`];

      if (['library', 'journeys'].includes(searchResult.category) && title && (!searchResult.is_leafnode || searchResult.is_asset)) {
        ...
        if (!imageUrl) {
          imageUrl = `${document.cdn_url}${searchResult.category === 'journeys' ? root.JOURNEY_ICON : root.LIBRARY_ICON}`;
        }
