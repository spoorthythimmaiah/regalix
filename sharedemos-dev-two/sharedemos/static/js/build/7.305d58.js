...
/***/ "./sharedemos/static/libs/jquery-ui/jquery-ui.min.js":
/*!***********************************************************!*\
  !*** ./sharedemos/static/libs/jquery-ui/jquery-ui.min.js ***!
  \***********************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! jQuery UI - v1.11.3 - 2015-02-22
* http://jqueryui.com
...
(function (e) {
  ...
  e(document).mouseup(function () {
    ...
    drag: function (t, i, s) {
      ...
      })), s.snapElements[c].snapping = !1) : ("inner" !== f.snapMode && (n = m >= Math.abs(u - y), a = m >= Math.abs(d - b), o = m >= Math.abs(h - v), r = m >= Math.abs(l - g), n && (i.position.top = s._convertPositionTo("relative", {
  ...
  e.effects = {
    ...
    for ((u || l) && r.push("opacity"), e.effects.save(o, r), o.show(), e.effects.createWrapper(o), c || (c = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), u && (a = {
      opacity: 1
    }, a[v] = 0, o.css("opacity", 0).css(v, b ? 2 * -c : 2 * c).animate(a, m, g)), l && (c /= Math.pow(2, p - 1)), a = {}, a[v] = 0, s = 0; p > s; s++) n = {}, n[v] = (b ? "-=" : "+=") + c, o.animate(n, m, g).animate(a, m, g), c = l ? 2 * c : c / 2;

    l && (n = {
      opacity: 0
    }, n[v] = (b ? "-=" : "+=") + c, o.animate(n, m, g)), o.queue(function () {
...
//# sourceMappingURL=7.305d58.js.map