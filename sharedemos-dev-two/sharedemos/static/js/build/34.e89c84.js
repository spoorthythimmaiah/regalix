...
/***/ "./sharedemos/static/js/tenant/views/main.js":
/*!***************************************************!*\
  !*** ./sharedemos/static/js/tenant/views/main.js ***!
  \***************************************************/
...
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! underscore */ "./node_modules/underscore/underscore.js"), __webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! backbone */ "./node_modules/backbone/backbone.js"), __webpack_require__(/*! ../common */ "./sharedemos/static/js/tenant/common.js"), __webpack_require__(/*! ../../helpers/handlebars/i18n */ "./sharedemos/static/js/helpers/handlebars/i18n.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_, $, Backbone, Common, translate) {
  'use strict';
  ...
  var MainView = Backbone.View.extend({
    ...
    events: {
      ...
      'click .offline-mode .enable': function (e) {
        this.registerServiceWorker(e);
      },
    ...
    startDownloadOffline: function (event) {
      ...
      if (navigator.serviceWorker.controller) {
        ...
        for (var i = 0; i < walkthroughs_list.length; i++) {
          this.walkthrough_slug = walkthroughs_list[i].getAttribute('slug'); // slug wise downloading function

          var data = {
            'section': section_slug,
            'walkthrough': this.walkthrough_slug,
            'domain': domainPath,
            'is_walkthrough': true,
            'tenantFooterImage': tenantFooterImage
          };
      ...
      $('#main_container').addClass(downloadStatus); // this.successPlaylistOffline();        
        ...
        messageChannel.port1.onmessage = function (event) {
          if (event.data.is_error) {
            if (event.data.error_entity == 'section') {
              ...
              $('#' + event.data.walkthrough_slug).addClass('downloading-slug-error'); // add each slug to corresponding failed section-wise walkthroughs 
...
//# sourceMappingURL=34.e89c84.js.map