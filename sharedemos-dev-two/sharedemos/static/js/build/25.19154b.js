...
/***/ "./sharedemos/static/js/checklist/models/checklist_item.js":
/*!*****************************************************************!*\
  !*** ./sharedemos/static/js/checklist/models/checklist_item.js ***!
  \*****************************************************************/
...
/***/ "./sharedemos/static/js/checklist/models/checklist_section.js":
/*!********************************************************************!*\
  !*** ./sharedemos/static/js/checklist/models/checklist_section.js ***!
  \********************************************************************/
/*! no static exports found */
...
/***/ "./sharedemos/static/js/checklist/models/checklist_suggestion.js":
/*!***********************************************************************!*\
  !*** ./sharedemos/static/js/checklist/models/checklist_suggestion.js ***!
  \***********************************************************************/
/*! no static exports found */
...
/***/ "./sharedemos/static/js/checklist/templates/chapter.handlebars":
/*!*********************************************************************!*\
  !*** ./sharedemos/static/js/checklist/templates/chapter.handlebars ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./sharedemos/static/js/checklist/templates/edit.handlebars":
/*!******************************************************************!*\
  !*** ./sharedemos/static/js/checklist/templates/edit.handlebars ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
    ...
    + container.escapeExpression(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(depth0 != null ? depth0 : (container.nullContext || {}),"add checklist",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":4,"column":9},"end":{"line":4,"column":34}}}))
    + "</h3>\r\n	</div>\r\n";
  ...
  return "	<div class=\"add-block\" data-popup=\"checklist_section\" checklist_section>\r\n	    <img src=\"/static/images/author/add_pathfinder.png\" />\r\n	    <h3>"
    + alias1(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(depth0 != null ? depth0 : (container.nullContext || {}),"add step",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":11,"column":9},"end":{"line":11,"column":29}}}))
    + " "
    ...
    + container.escapeExpression(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(depth0 != null ? depth0 : (container.nullContext || {}),"add checklist item",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":18,"column":9},"end":{"line":18,"column":39}}}))
    + "</h3>\r\n	</div>\r\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "	<div class=\"add-block\" data-popup=\"add_suggestions\" checklist_suggestion>\r\n	    <img src=\"/static/images/author/add_pathfinder.png\" />\r\n	    <h3>"
    + container.escapeExpression(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(depth0 != null ? depth0 : (container.nullContext || {}),"add suggestion",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":25,"column":9},"end":{"line":25,"column":35}}}))
    + "</h3>\r\n	</div>\r\n";
  ...
  return "		        <div class=\"checklist-edit-option edit\" data-popup=\"checklist\">\r\n		        	"
    + alias2(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(alias1,"edit checklist",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":34,"column":11},"end":{"line":34,"column":37}}}))
    + "\r\n		        </div>\r\n"
    ...
    + alias2(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(alias1,"delete checklist",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":46,"column":11},"end":{"line":46,"column":39}}}))
    + "\r\n		        </div>\r\n";
},"11":function(container,depth0,helpers,partials,data) {
    return "			        <div class=\"checklist-edit-option enable\" data-popup=\"confirm_enable\" data-type=\"checklist\">\r\n			        	"
    + container.escapeExpression(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(depth0 != null ? depth0 : (container.nullContext || {}),"enable checklist",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":38,"column":12},"end":{"line":38,"column":40}}}))
    + "\r\n			        </div>\r\n";
},"13":function(container,depth0,helpers,partials,data) {
    return "			        <div class=\"checklist-edit-option disable\" data-popup=\"confirm_disable\" data-type=\"checklist\">\r\n			        	"
    + container.escapeExpression(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(depth0 != null ? depth0 : (container.nullContext || {}),"disable checklist",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":42,"column":12},"end":{"line":42,"column":41}}}))
    + "\r\n			        </div>\r\n";
},"15":function(container,depth0,helpers,partials,data) {
    var alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.escapeExpression;

  return "		        <div class=\"checklist-edit-option edit\" data-popup=\"checklist_section\">\r\n		        	"
    + alias2(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(alias1,"edit checklist step",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":51,"column":11},"end":{"line":51,"column":42}}}))
    + "\r\n		        </div>\r\n		        <div class=\"checklist-edit-option delete\" data-popup=\"confirm_delete\" data-type=\"checklist-step\">\r\n		        	"
    + alias2(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(alias1,"delete checklist step",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":54,"column":11},"end":{"line":54,"column":44}}}))
    + "\r\n		        </div>\r\n";
},"17":function(container,depth0,helpers,partials,data) {
    var alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.escapeExpression;

  return "		        <div class=\"checklist-edit-option edit\" data-popup=\"checklist_item\">\r\n		        	"
    + alias2(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(alias1,"edit checklist item",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":60,"column":11},"end":{"line":60,"column":42}}}))
    + "\r\n		        </div>\r\n		        <div class=\"checklist-edit-option delete\" data-popup=\"confirm_delete\" data-type=\"checklist-item\">\r\n		        	"
    + alias2(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(alias1,"delete checklist item",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":63,"column":11},"end":{"line":63,"column":44}}}))
    + "\r\n		        </div>\r\n";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"is_external_link") : depth0),{"name":"if","hash":{},"fn":container.program(20, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":68,"column":4},"end":{"line":70,"column":11}}})) != null ? stack1 : "")
    ...
    + container.escapeExpression(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(alias1,"remove",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":71,"column":101},"end":{"line":71,"column":119}}}))
    + "</div>\r\n";
},"20":function(container,depth0,helpers,partials,data) {
    return "					<div class=\"checklist-edit-option edit\" data-popup=\"edit_suggestion\">"
    + container.escapeExpression(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(depth0 != null ? depth0 : (container.nullContext || {}),"edit suggestion",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":69,"column":74},"end":{"line":69,"column":101}}}))
    + "</div>\r\n";
...
/***/ "./sharedemos/static/js/checklist/templates/url_unfurling.handlebars":
/*!***************************************************************************!*\
  !*** ./sharedemos/static/js/checklist/templates/url_unfurling.handlebars ***!
  \***************************************************************************/
/*! no static exports found */
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"url_unfurling_block\">\n    <div class=\"thumb\">\n        <img src=\""
    ...
    + "\n        </div>\n        <div class=\"remove\">"
    + alias2(__default(__webpack_require__(/*! ./sharedemos/static/js/helpers/handlebars/i18n.js */ "./sharedemos/static/js/helpers/handlebars/i18n.js")).call(alias3,"remove link",{"name":"i18n","hash":{},"data":data,"loc":{"start":{"line":12,"column":28},"end":{"line":12,"column":51}}}))
    + "</div>\n    </div>\n</div>";
},"useData":true});

/***/ }),

/***/ "./sharedemos/static/js/checklist/views/edit.js":
/*!******************************************************!*\
  !*** ./sharedemos/static/js/checklist/views/edit.js ***!
  \******************************************************/
/*! no static exports found */
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*global define*/
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! underscore */ "./node_modules/underscore/underscore.js"), __webpack_require__(/*! jquery */ "jquery"), __webpack_require__(/*! backbone */ "./node_modules/backbone/backbone.js"), __webpack_require__(/*! ../../tenant/common */ "./sharedemos/static/js/tenant/common.js"), __webpack_require__(/*! ../models/checklist */ "./sharedemos/static/js/checklist/models/checklist.js"), __webpack_require__(/*! ../models/checklist_section */ "./sharedemos/static/js/checklist/models/checklist_section.js"), __webpack_require__(/*! ../models/checklist_item */ "./sharedemos/static/js/checklist/models/checklist_item.js"), __webpack_require__(/*! ../models/checklist_suggestion */ "./sharedemos/static/js/checklist/models/checklist_suggestion.js"), __webpack_require__(/*! ../../tenant/models/product-tree */ "./sharedemos/static/js/tenant/models/product-tree.js"), __webpack_require__(/*! ../templates/edit.handlebars */ "./sharedemos/static/js/checklist/templates/edit.handlebars"), __webpack_require__(/*! ../templates/popup.handlebars */ "./sharedemos/static/js/checklist/templates/popup.handlebars"), __webpack_require__(/*! ../templates/checklist_block.handlebars */ "./sharedemos/static/js/checklist/templates/checklist_block.handlebars"), __webpack_require__(/*! ../templates/checklist_section.handlebars */ "./sharedemos/static/js/checklist/templates/checklist_section.handlebars"), __webpack_require__(/*! ../templates/checklist_item.handlebars */ "./sharedemos/static/js/checklist/templates/checklist_item.handlebars"), __webpack_require__(/*! ../templates/checklist_suggestion.handlebars */ "./sharedemos/static/js/checklist/templates/checklist_suggestion.handlebars"), __webpack_require__(/*! ../templates/url_unfurling.handlebars */ "./sharedemos/static/js/checklist/templates/url_unfurling.handlebars"), __webpack_require__(/*! ../templates/chapter.handlebars */ "./sharedemos/static/js/checklist/templates/chapter.handlebars"), __webpack_require__(/*! ../../helpers/handlebars/i18n */ "./sharedemos/static/js/helpers/handlebars/i18n.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (_, $, Backbone, Common, Checklist, ChecklistSection, ChecklistItem, ChecklistSuggestion, ProductTree, EditTemplate, PopupTemplate, ChecklistBlockTemplate, ChecklistSectionBlockTemplate, ChecklistItemBlockTemplate, ChecklistSuggestionTemplate, UrlUnfurlTemplate, ChapterTemplate, Translate) {
  'use strict';
  ...
  var EditView = Backbone.View.extend({
    ...
    cacheChapterSuggestions: function (event) {
      ...
      this._chapters = _.map(selectedChapters, function (elem) {
        return elem.value;
      });
    },
    ...
    loadChapters: function (data, id, level, type, parent) {
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (type == "demo") {
          ...
          if (root._chapters.includes(chapter.slug)) {
    ...
    deleteEntity: function (event) {
      ...
      if (entity_type == 'checklist') {
        ...
        var checklist_section = new ChecklistSection({
          id: checklist_section_id
        });
        ...
        var checklist_item = new ChecklistItem({
        ...
        var checklist_suggestion = new ChecklistSuggestion({
          id: checklist_suggestion_id
        });
    ...
    editEntity: function (event) {
      ...
      if (popupName == "checklist") {
        ...
        var checklist_section = new ChecklistSection({
          'id': parseInt(checklistSectionId)
        });
        ...
        var checklist_suggestion = new ChecklistSuggestion({
          'id': parseInt(checklistSuggestionId)
        });
    ...
    listSuggestions: function (checklist_item) {
      ...
      if (checklist_item_elem.length == 0) {
        var sortable_div_elem = '<div class="suggestions_title">SUGGESTED CONTENT : </div>' + '<div class="sortable-wrap ui-sortable"></div>';
      ...
      _.each(checklist_item.suggestions, function (suggestion, index) {
        root.$('#item_' + checklist_item.checklist_item_id + ' .sortable-wrap').append(ChecklistSuggestionTemplate({
        ...
        root.checklist.save(null, {
          ...
          success: function (response) {
            ...
            if (root.is_edit_checklist == undefined) {
              root.$('ul.checklists.featured_list').append(ChecklistBlockTemplate({
                'checklist': response,
                'is_edit': true
              }));
              var attrs = {};
...
//# sourceMappingURL=25.19154b.js.map