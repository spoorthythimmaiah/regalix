...
DB_HOST = "10.223.240.116"
BROKER_HOST = "10.176.128.129"
REDIS_HOST = "10.223.208.73"
...
# CDN Settings
ASSET_CDN_URL = "https://cdn-prod.scdn6.secure.raxcdn.com"

# Wistia configuration.
WISTIA_PROJECT_ID = '7vrickfhgq'
...
STYLE_GUIDE_CLASS = {
    'infohub.delltechnologies.com': 'aphukh-style',

    # List of tenants below this are testing tenants,
    # please add production tenants above this comment.
    # For testing purpose only the value will be same as emc-dell tenant.
    # For other tenants, the value must be different.
    # 'aphukh-style' --> for Dell tenant.
    'infohubs.sharedemos.com': 'aphukh-style',
    'pooja.sharedemos.com': 'aphukh-style',
    'test-designeverest.sharedemos.com': 'spenden-style',
    'designeverestuniversity.com': 'spenden-style'
}
